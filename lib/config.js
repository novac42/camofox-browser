...
function loadConfig() {
  return {
    ...
    interactiveLoginEnabled: String(process.env.CAMOFOX_INTERACTIVE_LOGIN || '').toLowerCase() === 'true',
    interactiveLoginTtlSec: parseInt(process.env.CAMOFOX_INTERACTIVE_LOGIN_TTL_SEC) || 600,
    maxLoginSessions: parseInt(process.env.MAX_LOGIN_SESSIONS) || 100,
    ...
    serverEnv: {
      ...
      CAMOFOX_INTERACTIVE_LOGIN: process.env.CAMOFOX_INTERACTIVE_LOGIN,
      CAMOFOX_INTERACTIVE_LOGIN_TTL_SEC: process.env.CAMOFOX_INTERACTIVE_LOGIN_TTL_SEC,
      CAMOFOX_COOKIES_DIR: process.env.CAMOFOX_COOKIES_DIR,
      MAX_LOGIN_SESSIONS: process.env.MAX_LOGIN_SESSIONS,
